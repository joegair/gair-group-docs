...
function initSearch() {
  ...
  request.open('GET', 'http://localhost:4000/gair_group_docs/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gair_group_docs/assets/css/just-the-docs-' + theme + '.css');
}
