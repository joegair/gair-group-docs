...
function initSearch() {
  ...
  request.open('GET', 'http://localhost:4000/gair-group-docs/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gair-group-docs/assets/css/just-the-docs-' + theme + '.css');
}
